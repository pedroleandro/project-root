...
<!--                    </div>-->
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form id="formRegister" name="formRegister" action="register" method="POST" autocomplete="off">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input id="passwd" type="password" class="form-control pwstrength" data-indicator="pwindicator" name="passwd">
...
<!--                                </div>-->
                                ...
                                <div class="form-group">
                                    <button id="btnRegister" type="submit" class="btn btn-primary btn-lg btn-block">
                                        Register
                                    </button>
                                </div>
