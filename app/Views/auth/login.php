...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="<?= base_url() ?>/stisla-master/node_modules/bootstrap-social/bootstrap-social.css">
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    ...
                    <!--                        <img src="-->
                    <? //= base_url() ?><!--/stisla-master/assets/img/stisla-fill.svg" alt="logo" width="100"-->
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form id="formLogin" name="formLogin" action="login" method="POST" autocomplete="off" class="" novalidate="">
                                ...
                                <div class="form-group">
                                    <div class="d-block">
                                        ...
                                        <div class="float-right">
                                            <a href="recuperar" class="text-small">
                                                Forgot Password?
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <button id="btnLogin" type="submit" class="btn btn-primary btn-lg btn-block"
                                            tabindex="4">
                                        Login
                                    </button>
                                </div>
                    ...
                    <div class="mt-5 text-muted text-center">
                        Don't have an account? <a href="cadastrar">Create One</a>
                    </div>
...
<script src="<?= base_url() ?>/stisla-master/assets/js/page/formLogin.js"></script>
</body>
</html>
